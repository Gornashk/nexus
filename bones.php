...
function bones_scripts_and_styles() {
  if (!is_admin()) {
	...
	// wp_enqueue_script( 'jquery-ui', 'https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js', array('jquery'), '', false );
...
function bones_theme_support() {
	...
	add_image_size('homepage-banner','940','350',true);
	add_image_size('homepage-content-modules','197','141',true);
	...
	register_nav_menus(
		array(
			...
			'more-links' => __( 'More Links', 'bonestheme' ), // secondary nav in footer
			'mobile-nav' => __( 'Mobile Nav', 'bonestheme' ) // secondary nav in footer
		)
	);
...
function bones_main_nav() {
    ...
    wp_nav_menu(array(
    	'container' => false,                           // remove nav containe
...
function bones_footer_more_links() {
	// display the wp3 menu if available
    wp_nav_menu(array(
    	'container' => '',                              // remove nav container
    	'container_class' => 'footer-links clearfix',   // class of container (should you choose to use it)
    	'menu' => __( 'More Links', 'bonestheme' ),   // nav name
    	'menu_class' => 'nav footer-nav clearfix',      // adding custom nav class
    	'theme_location' => 'more-links',             // where it's located in the theme
    	'before' => '',                                 // before the menu
        'after' => '',                                  // after the menu
        'link_before' => '',                            // before each link
        'link_after' => '',                             // after each link
